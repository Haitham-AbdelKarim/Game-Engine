...
int main(int argc, char **argv) {
  ...
  // configuration Default: "config/app.json"
  ...
  // automatically closing This is useful for testing multiple configurations in
  // a batch Default: 0 where the application runs indefinitely until manually
  // closed
