...
namespace our {
    ...
    public:
        ...
        Sampler() {
            ...
            // generate new sampler with the given name
        ...
        ~Sampler() { 
            //TODO: (Req 6) Complete this function
            // delate the sampler with the given name
        ...
        void bind(GLuint textureUnit) const {
            //TODO: (Req 6) Complete this function
            // Bind the sampler with the given name
        ...
        static void unbind(GLuint textureUnit){
            //TODO: (Req 6) Complete this function
            // unbind the sampler with the given name
        ...
        void set(GLenum parameter, GLint value) const {
            //TODO: (Req 6) Complete this function
            // set the integer parameters of the sampler
        ...
        void set(GLenum parameter, GLfloat value) const {
            //TODO: (Req 6) Complete this function
            // set the float parameters of the sampler
