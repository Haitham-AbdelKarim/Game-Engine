...
namespace our {
    ...
    public:
        ...
        T* addComponent(){
            ...
            T* newComponent = new T(); // Create a new component
            newComponent->owner = this; // Set the owner to this entity
            components.push_back(newComponent); // Add the newComponent to components list
        ...
        T* getComponent(){
            ...
            if(ptr) { // If not null so it can be dynamically cast to "T*" 
                return ptr;
            }
        }
        return nullptr;
        ...
        void deleteComponent(T const* component){
            ...
            if (it != components.end()) { // component is found
                components.erase(it); // remove it from the components list
                delete component;   // delete it
            }
        }
        ...
        ~Entity(){
            ...
            for (auto component : components) {
                delete component; // delete every single component
            }
